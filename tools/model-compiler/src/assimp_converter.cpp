...
namespace convert {
        ...
        graphics::static_mesh& mesh) const
    {
        ...
        std::vector<sigmafive::graphics::static_mesh::triangle> triangles;
        for (unsigned int i = 0; i < aiScene->mNumMeshes; ++i) {
            ...
            std::vector<sigmafive::graphics::static_mesh::vertex> submesh_vertices(aimesh->mNumVertices);
            ...
            std::vector<sigmafive::graphics::static_mesh::triangle> submesh_triangles(aimesh->mNumFaces);
...
void assimp_import::import_file(sigmafive::entity::entity_manager
*entity_manager_,
                                sigmafive::entity::component_manager
*component_manager_,
...
//???
    ...
    std::unordered_map<int, std::shared_ptr<sigmafive::graphics::static_mesh>>
static_meshes;
    ...
    for (unsigned int i = 0; i < scene->mNumMeshes; ++i) {
        ...
        std::vector<sigmafive::graphics::static_mesh::vertex>
vertices(mesh->mNumVertices);
        std::vector<sigmafive::graphics::static_mesh::triangle>
triangles(mesh->mNumFaces);
        ...
        static_meshes[i] =
std::make_shared<sigmafive::graphics::static_mesh>(sigmafive::resource::identifier{path/name});
    ...
    for (unsigned int i = 0; i < scene->mRootNode->mNumChildren; ++i) {
        ...
        auto tc =
component_manager_->add_component<sigmafive::game::transform_component>(e);
        ...
        auto smc =
component_manager_->add_component<sigmafive::game::static_mesh_component>(e);

#ifndef SIGMAFIVE_ENTITY_COMPONENT_SYSTEM_MANAGER_HPP
#define SIGMAFIVE_ENTITY_COMPONENT_SYSTEM_MANAGER_HPP
...
namespace sigmafive {
    namespace entity {
        class SIGMAFIVE_API component_system_manager {
        public:
...
#endif //SIGMAFIVE_ENTITY_COMPONENT_SYSTEM_MANAGER_HPP

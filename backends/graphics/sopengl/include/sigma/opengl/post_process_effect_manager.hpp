...
namespace opengl {
    ...
    public:
        post_process_effect_manager(resource::cache<graphics::post_process_effect>& cache, texture_manager& textures, shader_manager& shaders, static_mesh_manager& meshes);

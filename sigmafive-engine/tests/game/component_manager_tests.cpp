...
protected:
    ...
    virtual void SetUp() override {
        registry.register_component(fake_1_component::CLASS_ID,
                                    std::unique_ptr<fake_1_component_component_pool_factory>(new fake_1_component_component_pool_factory{}));
        registry.register_component(fake_2_component::CLASS_ID,
                                    std::unique_ptr<fake_2_component_component_pool_factory>(new fake_2_component_component_pool_factory{}));
    }

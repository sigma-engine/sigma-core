...
struct quaternion_t {
    ...
    operator mat3x3_t<T>() const {
        return mat3x3_t<T>(vec3_t<T>(1 - 2 * this->y * this->y - 2 * this->z * this->z,
                                     2 * this->x * this->y - 2 * this->z * this->w,
                                     2 * this->x * this->z + 2 * this->y * this->w),
                           vec3_t<T>(2 * this->x * this->y + 2 * this->z * this->w,
                                     1 - 2 * this->x * this->x - 2 * this->z * this->z,
                                     2 * this->y * this->z - 2 * this->x * this->w),
                           vec3_t<T>(2 * this->x * this->z - 2 * this->y * this->w,
                                     2 * this->y * this->z + 2 * this->x * this->w,
    ...
    operator mat4x4_t<T>() const {
        return mat4x4_t<T>(vec4_t<T>(1 - 2 * this->y * this->y - 2 * this->z * this->z,
                                     2 * this->x * this->y - 2 * this->z * this->w,
                                     2 * this->x * this->z + 2 * this->y * this->w, 0),
                           vec4_t<T>(2 * this->x * this->y + 2 * this->z * this->w,
                                     1 - 2 * this->x * this->x - 2 * this->z * this->z,
                                     2 * this->y * this->z - 2 * this->x * this->w, 0),
                           vec4_t<T>(2 * this->x * this->z - 2 * this->y * this->w,
                                     2 * this->y * this->z + 2 * this->x * this->w,
                                     1 - 2 * this->x * this->x - 2 * this->y * this->y, 0),
                           vec4_t<T>(0, 0, 0, 1)
        );
    }

    ...
    namespace graphics {
        namespace opengl {
            ...
            void vertex_array::bind(const vertex_buffer_base &buffer, unsigned int index,
                                    unsigned int number_of_components, data_types component_type, bool normalize,
                                    const void *offset) {
                ...
                gl::VertexAttribPointer(index, number_of_components, component_type, static_cast<GLboolean>(normalize),
                                        static_cast<GLsizei>(buffer.stride()), offset); //TODO GL_CHECK_ERROR;
            }
            ...
            void vertex_array::draw(primitive_type mode, const index_buffer &index_buffer, std::size_t first,

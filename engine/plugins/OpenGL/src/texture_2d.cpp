        ...
        namespace opengl {
            ...
            void texture_2d::set_minification_filtering_mode(filtering_mode minification_filtering_mode) {
                ...
                gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_MIN_FILTER,
                                  (GLenum) minification_filtering_mode); //TODO GL_CHECK_ERROR;
            }
            ...
            void texture_2d::set_magnification_filtering_mode(filtering_mode magnification_filtering_mode) {
                ...
                gl::TexParameteri(gl::TEXTURE_2D, gl::TEXTURE_MAG_FILTER,
                                  (GLenum) magnification_filtering_mode); //TODO GL_CHECK_ERROR;
            }
            ...
            float4 texture_2d::border_color() const {
                ...
                float4 border_color;
                gl::GetTexParameterfv(gl::TEXTURE_2D, gl::TEXTURE_BORDER_COLOR,
                                      &border_color[0]); //TODO GL_CHECK_ERROR; and border_color.data()
                return border_color;
            }

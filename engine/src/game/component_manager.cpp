...
namespace sigmafive {
	namespace game {
        ...
        component *component_manager::add_component(unsigned long component_id, entity e) {
        ...
        bool component_manager::has_component(unsigned long component_id, entity e) {
            if(e.index >= component_masks_.size())
                return false;
        ...
        component *component_manager::get_component(unsigned long component_id, entity e) {
            auto it = component_pools_.find(component_id);
            if(it == component_pools_.end())
                return nullptr;
        ...
        void component_manager::remove_component(unsigned long component_id,entity e) {
            auto it = component_pools_.find(component_id);
